...
import { IHubProtocol, ProtocolType, MessageType, HubMessage, InvocationMessage, ResultMessage, CompletionMessage, StreamInvocationMessage } from "@aspnet/signalr-client";
import { BinaryMessageFormat } from "./BinaryMessageFormat"
import * as msgpack5 from "msgpack5";

// This shim is needed to handle the fact that msgpack is exported like a CommonJS module
// but we're building as an ECMAScript module.
function msgpackshim(): msgpack5.MessagePack {
    return <msgpack5.MessagePack>msgpack5.call({});
}

export class MessagePackHubProtocol implements IHubProtocol {

    readonly name: string = "msgpack";
